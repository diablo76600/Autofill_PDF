...
# Form implementation generated from reading ui file '/home/diablo76/Bureau/Test_Python/pythonTest/Save_PDF/save_pdf.ui'
#
...
class ModifyPdf(MainWindow):
    ...
    def select_destination(self):
        new_file, _ = QtWidgets.QFileDialog.getSaveFileName(
            parent=self, caption="Sauvegarder le fichier PDF", directory=str(Path.home())+ "/" + "Nouveau_fichier.pdf")
        return new_file
    
    def control_fields(self):
        if self.lineEdit_pdf.text() and self.lineEdit_number.text():
            return True
        return False
